...
# Defining global variables and custom gates
...
# Defining ideal output state of logical MSD
...
# Logical MSD with ideal error correction in the end. All depolarizing noise added
